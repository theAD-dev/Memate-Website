    ...
    data-aos-anchor-placement="top-bottom">
        ...
        <div className="section3 copyrightWrapper">
          <div className="copyright">
            {/* <p>© MeMate 2024 </p> */}
            <Link to="https://www.thead.com.au/" target="_blank"><p>Copyright © 2022-2025 | meMate</p></Link>
            <div className="copyright-links"><img src="https://res.cloudinary.com/dn0jqjad3/image/upload/v1747717590/Powered-By_logo-stack_CMYK_ew121c.webp" /></div>
          </div>
