          ...
          </div>
          {
            activeCategory === 0 && <>
              ...
              <div className="img-container-3 parent-blog-pageWrap">
               ...
               <div className="img-container-3-div">
                <div className="img-container-3-img1-div">
                  <Link to={`/news/${postsLatest[1]?.slug}`}>
                    <img
                      className="img-container-3-img-1"
                  ...
                  <div className="img-heading-container">
                    ...
                    <div className="date-heading-mainb"><Link to={`/news/${postsLatest[1].slug}`}>{postsLatest[1].title}</Link></div>
                  </div>
                  <div className='postCategory postCategoryb'>
               ...
               <div className="img-container-3-div">
                <div className="img-container-3-img1-div">
                  <Link to={`/news/${postsLatest[2]?.slug}`}>
                    <img
                      className="img-container-3-img-1"
                  ...
                  <div className="img-heading-container">
                    ...
                    <div className="date-heading-mainb"><Link to={`/news/${postsLatest[2].slug}`}>{postsLatest[2].title}</Link></div>
                  </div>
                  <div className='postCategory postCategoryb'>
